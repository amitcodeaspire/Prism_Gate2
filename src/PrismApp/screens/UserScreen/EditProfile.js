  ...
  const handleSubmit = async () => {
    ...
    if (details.Name) {
      try {
        ...
        const url2 = `https://prism-worker-gate-default-rtdb.firebaseio.com/Users/${authCtx.uid}/Details.json?auth=${authCtx.token}`;
        const response = await axios.put(url2, details);
        ...
        // Alert.alert(
        //   'SuccessFull Saved',
        //   'New Details of Profile Hase Been Saved',
        // );
